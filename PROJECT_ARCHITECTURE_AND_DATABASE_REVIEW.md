...
Repository foundation comes first: pnpm/Turborepo, React/Vite, NestJS, Docker Compose PostgreSQL, environment template, and health endpoint. Then Prisma/Neon configuration and migrations infrastructure, followed by identity/tenancy, auth, RBAC, customers, catalog, plans/prices, subscriptions, quotations, invoices, payments/refunds, discounts/taxes, reporting, frontend completion, tests/hardening, and AI only later. Build business modules only after their design and dependencies are reviewed.
